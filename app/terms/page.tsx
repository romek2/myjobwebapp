  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-blue max-w-none">
        ...
        <p>
          To access certain features of the Services, you must register for an account. When you register, you 
        ...
        <ul>
          ...
          <li>
            Upload or transmit viruses, malware, or other malicious code, or interfere with or disrupt the integrity 
            or performance of the Services.
          </li>
          <li>
            Attempt to gain unauthorized access to any part of the Services, or systems or networks connected to the 
            Services.
          </li>
          <li>
            Use automated means, including spiders, robots, crawlers, or similar technologies, to access the Services 
            or collect content from the Services.
          </li>
          <li>
            Create multiple accounts, impersonate another person, or misrepresent your affiliation with any person or 
            entity.
          </li>
        </ul>
        ...
        <h2>User Content</h2>
        <p>
          Our Services allow you to upload, post, or otherwise make available content, including your resume, profile 
          information, and other materials (collectively, "User Content"). You retain ownership of your User Content, 
          but you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, adapt, publish, 
          translate, and display your User Content in connection with providing and promoting the Services.
        </p>
        <p>
          You represent and warrant that you own or have the necessary rights to your User Content, and that your User 
          Content does not infringe or violate the rights of any third party or violate any laws.
        </p>

        <h2>Subscription Services</h2>
        <p>
          We offer both free and paid subscription options. By subscribing to our paid Services (PRO membership), you 
          agree to pay all fees associated with the subscription plan you select. Fees are non-refundable except as 
          required by law or as explicitly stated in these Terms.
        </p>
        <p>
          Subscriptions automatically renew unless you cancel before the renewal date. You can cancel your subscription 
          at any time through your account settings or by contacting us. If you cancel, you will continue to have access 
          to the paid features until the end of your current billing period.
        </p>
        ...
        <p>
          While we strive to provide accurate job listings and matching services, we do not guarantee the accuracy, 
          completeness, or reliability of any job postings, employer information, or matching results. You should 
          independently verify the accuracy of any job listing or employer information before making any decisions based 
          on such information.
        </p>
        ...
        <p>
          ...
          SERVICES; OR (D) UNAUTHORIZED ACCESS, USE, OR ALTERATION OF YOUR TRANSMISSIONS OR CONTENT, WHETHER BASED ON 
        ...
        <p>
          ...
          email or through a notice on our website prior to the changes becoming effective. Your continued use of the 
          Services after the effective date of the revised Terms constitutes your acceptance of the changes.
        </p>
        ...
        <p>
          ...
          the courts located within Delaware for the resolution of any disputes arising out of or relating to these 
