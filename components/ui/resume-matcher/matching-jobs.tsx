// components/ui/resume-matcher/matching-jobs.tsx - WITH HIGHLIGHTED CHANGES
...
import ApplicationModal from './ApplicationModal'; // ← ADDED: Import modal
...
const MatchingJobs: React.FC<MatchingJobsProps> = ({ 
 ...
 const [selectedJob, setSelectedJob] = useState<Job | null>(null); // ← ADDED: State for modal
 ...
 return (
         ...
         <CardContent className="p-5">
           ...
           <div className="mt-3">
             ...
             <div className="flex gap-3 mt-4">
               ...
               <button
                 onClick={() => setSelectedJob(job)} // ← CHANGED: Open modal instead of alert
  ...
  <ApplicationModal
    ...
    onSuccess={() => setSelectedJob(null)} // ← ADDED: onSuccess prop
  />
)}
   </div>
 );
